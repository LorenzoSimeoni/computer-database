    ...
    <footer class="navbar-fixed-bottom">
        <div class="container text-center">
            <ul class="pagination">
              ...
              <li><a href="showComputer?page=1">1</a></li>
              <li><a href="showComputer?page=2">2</a></li>
              <li><a href="showComputer?page=3">3</a></li>
              <li><a href="showComputer?page=4">4</a></li>
              <li><a href="showComputer?page=5">5</a></li>
              <li>
